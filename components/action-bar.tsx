...
const className =
  "flex flex-1 items-center justify-center gap-x-2 bg-white bg-opacity-5 py-3 text-xs uppercase tracking-widest backdrop-blur overflow-hidden whitespace-nowrap";

const ActionBar: React.FC<IActionBar> = ({ actions }) => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 flex gap-x-2 p-4">
